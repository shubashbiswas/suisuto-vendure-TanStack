		...
		<section className="relative w-full overflow-hidden bg-black text-white">
			<div className="relative w-full aspect-16/9 sm:aspect-21/9 max-h-[75vh] min-h-[360px] flex items-center justify-center">
				...
				<div className="relative z-10 container mx-auto px-4 text-center max-w-4xl py-12">
					<div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-[10px] font-mono uppercase tracking-[0.25em] text-amber-300 mb-4 animate-in fade-in duration-700">
						<Sparkles className="size-3 text-amber-400" />
						<span>Runway & Heritage Showcase 2026</span>
					</div>

					<h1 className="font-serif text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight text-white mb-4 drop-shadow-md">
						{title}
					</h1>

					<p className="text-xs sm:text-sm md:text-base text-white/80 font-sans max-w-2xl mx-auto leading-relaxed mb-6 drop-shadow">
						{subtitle}
					</p>

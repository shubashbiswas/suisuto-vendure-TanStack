...
import { BdTopRibbon } from "@/site/navigation/navbar/bd-top-ribbon";
import { BdCategoryNav } from "@/site/navigation/navbar/bd-category-nav";
	...
	if (isBd) {
		return (
			<header className="sticky top-0 left-0 right-0 z-50 transition-all shadow-xs">
				{/* Top Ribbon Menu: About US | Contact US -- Announcements -- Track order | call +8801308058580 */}
				<BdTopRibbon

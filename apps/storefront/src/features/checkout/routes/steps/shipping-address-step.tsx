...
export default function ShippingAddressStep({ onComplete }: ShippingAddressStepProps) {
  ...
  const { register, handleSubmit, formState: { errors }, reset, control, watch } = useForm<AddressFormData>({
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {watch('countryCode') === 'IN' && (
                <Field className="col-span-2 p-3.5 rounded-lg border border-amber-500/30 bg-amber-500/5 space-y-1">
                  <FieldLabel htmlFor="guest-recipientKycId" className="text-amber-900 dark:text-amber-200 font-semibold text-xs flex items-center gap-1.5">
                    <span>🇮🇳 Indian Customs Mandatory KYC</span>
                  </FieldLabel>
                  <Input
                    id="guest-recipientKycId"
            ...
            <form onSubmit={handleSubmit(onSaveNewAddress)}>
              ...
              <FieldGroup className="my-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {watch('countryCode') === 'IN' && (
                    <Field className="col-span-2 p-3.5 rounded-lg border border-amber-500/30 bg-amber-500/5 space-y-1">
                      <FieldLabel htmlFor="dialog-recipientKycId" className="text-amber-900 dark:text-amber-200 font-semibold text-xs flex items-center gap-1.5">
                        <span>🇮🇳 Indian Customs Mandatory KYC</span>
                      </FieldLabel>
                      <Input
                        id="dialog-recipientKycId"
                        placeholder="Aadhaar / PAN / Passport ID number"
                        {...register('recipientKycId')}
                        className="bg-background"
                      />
